...
server::server(boost::asio::io_service& io_service, short port, std::vector<std::string> parsed_config_paths)
...
{
  session* new_session = new session(io_service_, parsed_config_paths_); //initializes a tcp socket in member var socket_
