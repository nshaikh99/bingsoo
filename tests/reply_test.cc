...
//TODO: change ReplyTestFixture to reflect the refactored changes made to session.cc
//WHY: generate_response was removed from session.cc and replaced with reply::stock_reply
